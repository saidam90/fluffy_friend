...
pet_1 = Pet.create!(name: "Mr Humphries", category: "hamster", breed: "syrian hamster", age: 5, location: "86 Castledore Road", user: tommy)
...
pet_2 = Pet.create!(name: "Bubble", category: "dog", breed: "pug", age: 4, location: "35 Bullwood Rd", user: max)
...
pet_3 = Pet.create!(name: "Birdie", category: "bird", breed: "woodpecker", age: 5, location: "16 Northgate Street", user: saida)
...
pet_4 = Pet.create!(name: "Neko", category: "cat", breed: "birman", age: 8, location: "40 Wartnaby Road", user: dylan)
...
pet_5 = Pet.create!(name: "Makima", category: "rabbit", breed: "havana", age: 6, location: "62 Abingdon Road", user: tommy)
...
pet_6 = Pet.create!(name: "Dumbo", category: "elephant", breed: "bush", age: 10, location: "88 Marcham Road", user: max)
